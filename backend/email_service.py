...
UNSUBSCRIBE_BASE_URL = os.environ.get("APP_BASE_URL", "")
if not UNSUBSCRIBE_BASE_URL:
    import warnings
    warnings.warn(
        "APP_BASE_URL environment variable is not set. "
        "Unsubscribe links in outgoing emails will be broken. "
        "Set APP_BASE_URL to your deployed application URL (e.g. https://your-app.run.app).",
        stacklevel=1,
    )
...
def _sentiment_badge(label: str, score: int) -> str:
    ...
    styles = {
        ...
        "Neutral": ("&mdash;", "#b45309", "#fffbeb", "#fde68a"),
    }
